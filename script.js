...
const translations = {
    ...
    ku: {
        ...
        productSoap: "تایبات بە زیپکە، پەڵە ، حەساسیە",
        productVitamin: "پێستی ڕووناک و تازە دەکات",
        productArgan: "دژە هەڵوەرین، بەهێزکردن و درەوشان",
        productPerfumeWomen: "بۆنی ژنان",
        productPerfumeMen: "بۆنی پیاوان",
        productDonkey: "پێستی نەرم و هەڵوەشان دەکات",
        productCream: "پێستی سپی و نەرم دەکات",
        ...
        electronicsHeaderTitle: "ئەلیکترۆنیاتی بەکارهێنەران",
        ...
        perfumeHeaderSubtitle: "بۆنە باڵاکان ببینە کە ستایلی تایبەتی تۆ و کەسایەتی تۆ دەردەخەن.",
        ...
        aboutPageTitle: "دەربارەی فرۆشگاکەمان",
